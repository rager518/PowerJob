...
WINRT_EXPORT namespace winrt::Windows::Storage::Provider
{
    ...
    struct WINRT_IMPL_EMPTY_BASES StorageProviderError : winrt::Windows::Storage::Provider::IStorageProviderError
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES StorageProviderErrorCommand : winrt::Windows::Storage::Provider::IStorageProviderErrorCommand
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES StorageProviderStatus : winrt::Windows::Storage::Provider::IStorageProviderStatus
    {
