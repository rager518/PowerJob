...
{
    return createAppMutex(PowerJob_MSI_MUTEX_NAME);
}
...
int WINAPI WinMain(HINSTANCE /*hInstance*/, HINSTANCE /*hPrevInstance*/, LPSTR lpCmdLine, int /*nCmdShow*/)
{
    ...
    try
    {
        ...
        bool scoobeDisabledByGpo = PowerJob_gpo::getDisableShowWhatsNewAfterUpdatesValue() == PowerJob_gpo::gpo_rule_configured_enabled;
