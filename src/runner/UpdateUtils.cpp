                           ...
                           bool show_notifications)
{
    ...
    if (show_notifications && (disable_notification_setting || PowerJob_gpo::getDisableNewUpdateToastValue() == PowerJob_gpo::gpo_rule_configured_enabled))
    {
    ...
    else if (show_notifications && PowerJob_gpo::getSuspendNewUpdateToastValue() == PowerJob_gpo::gpo_rule_configured_enabled)
    {
...
void PeriodicUpdateWorker()
{
    for (;;)
    {
        ...
        if (PowerJob_gpo::getDisableAutomaticUpdateDownloadValue() == PowerJob_gpo::gpo_rule_configured_enabled)
        {
